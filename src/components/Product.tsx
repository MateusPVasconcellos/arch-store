...
function Product({
  ...
  return (
    <div
      className="mx-5 mt-5 flex w-72 rounded bg-gray-300 hover:bg-gray-400
     dark:bg-gray-600 dark:hover:bg-gray-800 md:h-[400px] md:max-h-[600px] lg:ml-6"
    >
      <section className="mx-2 block w-72 justify-center">
        <div className="relative m-2 block">
          <img src={imageUrl} alt="products" className="h-36 w-full" />
        </div>
        <div>
